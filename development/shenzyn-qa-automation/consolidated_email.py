...
toaddr = ["sarav.s@shenzyn.com","arun.i@shenzyn.com","megha.nimbargimath@shenzyn.com","debahuti.sahoo@shenzyn.com"]
...
for email in toaddr:
    ...
    <html>
      <body>
        <p>Hello,<br><br>Please find the attached Test Results for Jobseeker, Hiring Partner and Employer.
           <br>
           <br>Regards,
           <br>Shenzyn Testing Team
           <br><a href="http://www.shenzyn.com">Shenzyn</a> 
        </p>
      </body>
    </html>
    """
    ...
    mypath = r"/var/opt/Shenzyn-apps/Shenzyn-Test-Aut/development/shenzyn-qa-automation/zipfiles"
