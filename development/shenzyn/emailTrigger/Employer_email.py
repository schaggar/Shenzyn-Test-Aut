...
fromaddr = "sharanya_test@hotmail.com"
toaddr = ["sharanya.d@shenzyn.com","megha.nimbargimath@shenzyn.com","sarav.s@shenzyn.com"]
...
for email in toaddr:
    ...
    # storing the subject
    msg['Subject'] = "Employer Automation Test Results"

    # string to store the body of the mail
    body = "Please find the attached Test Results for Employer Automation"
